<?php
    ...
    if(!empty($busqueda)){
        ...
        $lista = $d->getListaDocentes($_SESSION["usuario_UnADM"]);
    }
...
<head>
    ...
    <script>
        function seleccionaDocente(folio, id) {
            ...
            menu.innerHTML = "<a href='index.php' class='boton'><button id='infoBtn' class='btn btn-danger'>Regresar</button></a><br><br>";
            menu.innerHTML += "<a href='../operador/form_evaluacion.php?docente="+folio+"&evaluacion=<?=@$_GET["evaluacion"]?>&evalPeriodo=<?=@$_GET["periodo"]?>' id='infoLink' class='boton'><button id='infoBtn' class='btn btn-success'>Evaluar docente</button></a><br><br>";
            <?php
                if(!empty($busqueda)){
            ?>
                    menu.innerHTML += "<a href='evaluarDocente.php?evaluacion=<?=@$_GET['evaluacion']?>&periodo=<?=@$_GET['periodo']?>' class='boton'><button class='btn btn-success'>Ver lista completa</button></a><br><br>"
            <?php
                }
            ?>
    ...
    <div class="container-fluid" style="padding: 0px !important;">
        ...
        <div class="row aguila"  style="position: absolute; top: 0px; padding-top: 126px; width: 100%; z-index: -1; height:100%; margin: 0px;  justify-content: center;">
            <div class="col-md-2 align-items-center" style="">
                <br>
                <center id='latmenu'>
                    <a href='index.php' class='boton'><button id='infoBtn' class='btn btn-danger'>Regresar</button></a><br><br>
                    <?php
                        if(!empty($busqueda)){
                    ?>
                            <a href="evaluarDocente.php?evaluacion=<?=@$_GET['evaluacion']?>&periodo=<?=@$_GET['periodo']?>" class="boton"><button class="btn btn-success">Ver lista completa</button></a><br><br>
                    <?php
                        }
                    ?>
                </center>
            ...
            <div class="col-md-10 align-items-center" style="padding: 0 5%; overflow-y: auto;">
                <center>
                    <br><h4>Selecciona un docente para evaluar</h4><br>
                    <div class="col-md-8" style="padding: 0 !important;">
                            <form id="busca" action="evaluarDocente.php" method="get" class="form">
